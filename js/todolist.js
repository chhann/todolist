...
function todoCheck(e) {
    ...
    let count = document.querySelector("#todolist").childElementCount
    
    let complete = document.querySelectorAll("input:checked");
    
    const h3 = document.querySelector("h3");

    h3.innerHTML = `할일 ${count-complete.length} / 끝난 일 ${complete.length} `
}
